...
export default function Carousel() {
  return (
    <div
      className="w-full max-w-6xl mx-auto mt-5 mb-5 px-4 sm:px-6"
      style={{ minHeight: 400 }}
    >
      <Swiper
      ...
      >
        {samples.map((sample, i) => (
          <SwiperSlide key={i}>
            <div className="flex flex-col items-center justify-center text-center h-[400px] md:h-[500px] bg-foreground text-white p-5 ">
